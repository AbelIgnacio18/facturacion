...
<?php 
                ...
                if(($value['codigo'] == 6) || ($value['codigo'] == 8)){
        ...
        //case 'OBTENER_TEFECTIVO':
            ...
            //case 'OBTENER_TTRANSFERENCIA':
                ...
                if($estado_envio['estado']==8){
                        ...
                        echo "COMPROBANTE CON OBSERVACIONES, REVISAR!!!";
                    }
?>
    ...
    function Guardar(){
        ...
        $.ajax({
            ...
            if(resultado=="aprobado"){
                ...
                icon: "success",
                title: "ACTUALIZADO...",
                text: "COMPROBANTE ACEPTADO POR SUNAT",
                ...
                icon: "error",
                title: "Oops...",
                text: "COMPROBANTE CON OBSERVACIONES, REVISAR!!!",
            }
